...
build:
	CGO_ENABLED=1 GO111MODULE=on go build -o ./bin/target/werewolf-story cmd/main.go

# generate the binary file for linux platform
build-linux:
	 GO111MODULE=on GOOS=linux GOARCH=amd64 go build -o ./bin/linux/werewolf-story cmd/main.go
